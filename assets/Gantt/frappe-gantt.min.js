var Gantt = (function() {
  ...
  var e = {
    ...
    to_string(t, e = !1) {
      ...
      const i = this.get_date_values(t).map(
          (t, e) => (1 === e && (t += 1), s(t + "", 6 === e ? 3 : 2, "0"))
        ),
        n = `${i[0]}-${i[1]}-${i[2]}`,
        a = `${i[3]}:${i[4]}:${i[5]}.${i[6]}`;
      return n + (e ? " " + a : "");
    ...
    diff(t, e, s = "day") {
      ...
      return (
        (d =
          (h = (r = (a = (o = (n = (i = t - e) / 1e3) / 60) / 60) / 24) / 30) /
          12),
        s.endsWith("s") || (s += "s"),
        Math.floor(
          {
  ...
  (i.on = (t, e, s, n) => {
    ...
    (i.closest = (t, e) =>
      e ? (e.matches(t) ? e : i.closest(t, e.parentNode)) : null),
    (i.attr = (t, e, s) => {
  ...
  class o {
    ...
    prepare_values() {
      (this.invalid = this.task.invalid),
        ...
        (this.duration =
          e.diff(this.task._end, this.task._start, "hour") /
    ...
    draw_resize_handles() {
      ...
      n("rect", {
        ...
        this.task.progress &&
          ...
          (this.$handle_progress = n("polygon", {
    ...
    setup_click_event() {
      i.on(this.group, "focus " + this.gantt.options.popup_trigger, t => {
        this.action_completed ||
          ("click" === t.type && this.gantt.trigger_event("click", [this.task]),
    ...
    show_popup() {
      ...
      const t =
        e.format(this.task._start, "MMM D", this.gantt.options.language) +
        " - " +
        e.format(
          e.add(this.task._end, -1, "second"),
          "MMM D",
    ...
    date_changed() {
      ...
      Number(this.task._start) !== Number(s) &&
        ((t = !0), (this.task._start = s)),
        Number(this.task._end) !== Number(i) &&
          ((t = !0), (this.task._end = i)),
        t &&
    ...
    compute_start_end_date() {
      ...
      return {
        new_start_date: i,
        new_end_date: e.add(i, n * this.gantt.options.step, "hour")
      };
    }
    compute_progress() {
    ...
    get_snap_position(t) {
      let e,
        s,
        i = t;
      return (s = this.gantt.view_is("Week")
        ? i -
  ...
  class p {
    ...
    setup_wrapper(t) {
      ...
      e
        ...
        : (this.$svg = n("svg", { append_to: s, class: "gantt" })),
    ...
    setup_tasks(t) {
      (this.tasks = t.map((t, s) => {
        if (
          ...
          const s = e.today();
          (t._start = s), (t._end = e.add(s, 2, "day"));
        }
        if (
          ...
          e
            ...
            .slice(3)
            .every(t => 0 === t) && (t._end = e.add(t._end, 24, "hour")),
    ...
    setup_gantt_dates() {
      ...
      (this.gantt_start = e.start_of(this.gantt_start, "day")),
        ...
        this.view_is([d.QUARTER_DAY, d.HALF_DAY])
          ? ((this.gantt_start = e.add(this.gantt_start, -7, "day")),
            (this.gantt_end = e.add(this.gantt_end, 7, "day")))
          : this.view_is(d.MONTH)
          ? ((this.gantt_start = e.start_of(this.gantt_start, "year")),
            (this.gantt_end = e.add(this.gantt_end, 1, "year")))
          : this.view_is(d.YEAR)
          ? ((this.gantt_start = e.add(this.gantt_start, -2, "year")),
      ...
      for (; null === t || t < this.gantt_end; )
        (t = t
          ? this.view_is(d.YEAR)
            ...
            : this.view_is(d.MONTH)
            ? e.add(t, 1, "month")
            : e.add(t, this.options.step, "hour")
          : e.clone(this.gantt_start)),
          this.dates.push(t);
    }
    bind_events() {
    ...
    make_grid_ticks() {
      ...
      for (let a of this.dates) {
        ...
        this.view_is(d.DAY) && 1 === a.getDate() && (o += " thick"),
          ...
          this.view_is(d.MONTH)
            ? (t += (e.get_days_in_month(a) * this.options.column_width) / 30)
    ...
    make_grid_highlights() {
      if (this.view_is(d.DAY)) {
        n("rect", {
          x:
            (e.diff(e.today(), this.gantt_start, "hour") / this.options.step) *
    ...
    get_date_info(t, s, i) {
      ...
      const n = {
          ...
          Week_lower:
            t.getMonth() !== s.getMonth()
              ? e.format(t, "D MMM", this.options.language)
              : e.format(t, "D", this.options.language),
          ...
          Day_upper:
            t.getMonth() !== s.getMonth()
              ? e.format(t, "MMMM", this.options.language)
              : "",
          Week_upper:
            t.getMonth() !== s.getMonth()
              ? e.format(t, "MMMM", this.options.language)
          ...
          Month_upper:
            t.getFullYear() !== s.getFullYear()
              ? e.format(t, "YYYY", this.options.language)
              : "",
          Year_upper:
            t.getFullYear() !== s.getFullYear()
              ? e.format(t, "YYYY", this.options.language)
      ...
      return {
        ...
        upper_x: a.x + o[`${this.options.view_mode}_upper`],
        upper_y: a.upper_y,
        lower_x: a.x + o[`${this.options.view_mode}_lower`],
        lower_y: a.lower_y
      };
    }
    make_bars() {
    ...
    set_scroll_position() {
      ...
      if (!t) return;
      const s =
        (e.diff(this.get_oldest_starting_date(), this.gantt_start, "hour") /
          this.options.step) *
          this.options.column_width -
        this.options.column_width;
      t.scrollLeft = s;
    ...
    bind_bar_events() {
      ...
      (this.bar_being_dragged = null),
        i.on(this.$svg, "mousedown", ".bar-wrapper, .handle", (h, d) => {
          const p = i.closest(".bar-wrapper", d);
          d.classList.contains("left")
            ? (n = !0)
            : d.classList.contains("right")
            ? (a = !0)
            : d.classList.contains("bar-wrapper") && (t = !0),
        ...
        document.addEventListener("mouseup", e => {
          (t || n || a) && r.forEach(t => t.group.classList.remove("active")),
            (t = !1),
            (n = !1),
            (a = !1);
        }),
        i.on(this.$svg, "mouseup", t => {
          (this.bar_being_dragged = null),
            r.forEach(t => {
    ...
    bind_bar_progress() {
      let t = 0,
        ...
        a = null,
        o = null;
      i.on(this.$svg, "mousedown", ".handle.progress", (r, h) => {
        (s = !0), (t = r.offsetX), (e = r.offsetY);
        ...
        i.on(this.$svg, "mousemove", e => {
          if (!s) return;
          let o = e.offsetX - t;
          e.offsetY;
          o > a.max_dx && (o = a.max_dx), o < a.min_dx && (o = a.min_dx);
        ...
        i.on(this.$svg, "mouseup", () => {
          (s = !1),
            a && a.finaldx && (n.progress_changed(), n.set_action_completed());
        });
    }
