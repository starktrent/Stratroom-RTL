    ...
    OrgChart.prototype = {
        ...
        createNode: function(data) {
            ...
            if (opts.nodeTemplate) {
                ...
                var image = '../../assets/images/media.png';
                if (data[opts.nodeImage]) {
                    image = data[opts.nodeImage];
                }
                // $nodeDiv.append('<div class="title">' + data[opts.nodeTitle] + '</div>')
                // .append(typeof opts.nodeContent !== 'undefined' ? '<div class="content">' + (data[opts.nodeContent] || '') + '</div>' : '');
                $nodeDiv.append(typeof opts.nodeContent !== 'undefined' ? '<div class="orgiz_structure_div"><div class="orgiz_add"><a href="#" onclick="return false;" class=" dropdown-toggle js-add_org_struct-sidebar" data-close="true"><img src="../../assets/images/awsomefont_add.png" width="15" alt=""></a></div><div class="orgiz_edit"><a href="#"><img src="../../assets/images/awsomefont_edit.png" width="15" alt=""></a></div><div class="orgiz_delete"><a href="#"><img src="../../assets/images/awsomefont_delete.png" width="15" alt=""></a></div><div class="d-flex flex-row org_box_top"><div class="flex-column"><img class="rounded-circle orgiz_image" src="' + image + '" width="25" alt="user"></div><div class="flex-column org_box_top_content"><input type="hidden" class="org_id" value="' + data[opts.nodeId] + '" /><div class="orgiz_name">' + data[opts.nodeName] + '</div><div class="orgiz_title">' + data[opts.nodeTitle] + '</div><div class="orgiz_department">' + data[opts.nodeDept] + '</div><div class="orgiz_kpi_name">' + data[opts.nodeKPI] + '</div></div></div><div class="d-flex flex-row org_box_bottom"><div class="orgiz_scorecard_btn"><a href="#"><button class="button orgiz_btn_scorecard green_color" name="scorecard" value=""><span>S</span></button> </a></div><div class="orgiz_kpi_btn"><a href="#"><button class="button orgiz_btn_kpi orange_color" name="kpi name" value=""><span>K</span></button> </a></div><div class="orgiz_initiative_btn"><a href="#"><button class="button orgiz_btn_init yellow_color" name="initiative" value=""><span>I</span></button> </a></div><div class="orgiz_scorecard_btn"><a href="#"><button class="button orgiz_btn_appraisal green_color" name="appraisal" value=""><span>A</span></button> </a></div></div></div>' : '');
