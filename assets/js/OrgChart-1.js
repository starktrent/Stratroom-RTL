var OrgChart = function(t, e) {
    ...
    for (var a = ["onUpdate", "onRemove", "onAdd", "onRedraw", "onImageUploaded", "onUpdateTags", "onClick", "onDbClick", "onExpCollClick", "onExportStart", "onExportEnd", "onSearchClick", "onReady"], n = 0; n < a.length; n++) {
        var o = a[n];
        this.config[o] && this.on(o.replace("on", "").toLowerCase(), this.config[o])
    }
    null != this.config.nodeMouseClickBehaviour && (this.config.nodeMouseClick = this.config.nodeMouseClickBehaviour), null != this.config.mouseScroolBehaviour && (this.config.mouseScrool = this.config.mouseScroolBehaviour), OrgChart._validateConfig(this.config) && (this.server = null, this._vScroll = {}, this.config.ui || (this.ui = OrgChart.ui), this.config.editUI ? this.editUI = this.config.editUI : this.editUI = new OrgChart.editUI, this.editUI.init(this), null === this.server && (this.server = new OrgChart.server(this.config)), this.config.searchUI ? this.searchUI = this.config.searchUI : this.searchUI = new OrgChart.searchUI, this.searchUI.init(this), this.config.nodeMenuUI ? this.nodeMenuUI = this.config.nodeMenuUI : this.nodeMenuUI = new OrgChart.menuUI, this.nodeMenuUI.init(this, this.config.nodeMenu), this.config.nodeContextMenuUI ? this.nodeContextMenuUI = this.config.nodeContextMenuUI : this.nodeContextMenuUI = new OrgChart.menuUI, this.nodeContextMenuUI.init(this, this.config.nodeContextMenu), this.config.toolbarUI ? this.toolbarUI = this.config.toolbarUI : this.toolbarUI = new OrgChart.toolbarUI, this.config.notifierUI ? this.notifierUI = this.config.notifierUI : this.notifierUI = new OrgChart.notifierUI, this.notifierUI.init(this), this.config.dragDropMenuUI ? this.dragDropMenuUI = this.config.dragDropMenuUI : this.dragDropMenuUI = new OrgChart.menuUI, this.dragDropMenuUI.init(this, this.config.dragDropMenu), this.config.menuUI ? this.menuUI = this.config.menuUI : this.menuUI = new OrgChart.menuUI, this.menuUI.init(this, this.config.menu), this.config.xScrollUI || (this.xScrollUI = new OrgChart.xScrollUI(this.element, this.config, function() {
        ...
        r._draw(!0, OrgChart.action.xScroll)
    })), this._gragStartedId = null, this._timeout = null, this._touch = null, this._initialized = !1, this.response = null, this.nodes = null, this._setInitialSizeIfNotSet(), OrgChart.events.publish("init", [this]), 0 < this.config.nodes.length && this._draw(!1, OrgChart.action.init))
};
OrgChart.prototype.load = function(t) {
    ...
    this.server.read(t, this.width(), this.height(), e, v, y, function(t) {
        ...
        for (var o in OrgChart.events.publish("prerender", [b, e]), r = e.content, t.visibleNodes) {
            var l = t.visibleNodes[o],
                s = b._get(o);
            r += b.ui.node(l, s, t.animations, b.config, void 0, void 0, void 0, v, i, b), r += b.ui.secondLinks(t.visibleNodes, l, b.config, t.boundary, i), r += b.ui.link(l, b, b.config, i), r += b.ui.expandCollapse(l, b.config, v, i)
        }
        e = {
            content: r,
            res: t
        ...
        if (OrgChart.events.publish("render", [b, e]), r = e.content, r += b.ui.lonely(b.config), v !== OrgChart.action.exporting) {
            v !== OrgChart.action.centerNode && v !== OrgChart.action.insert && v !== OrgChart.action.expandCollapse && v !== OrgChart.action.update || (n = a), v === OrgChart.action.init && null != a && (n = a), b.response = t;
            ...
            if (b._initialized) {
                ...
                b.element.innerHTML = b.ui.css() + b.ui.exportMenuButton(b.config) + O, b._attachInitEventHandlers(), b._attachEventHandlers(), b.config.showXScroll === OrgChart.scroll.visible && (b.xScrollUI.create(b.width(), b.config.padding), b.xScrollUI.setPosition(), b.xScrollUI.addListener(b.getSvg())), b.config.showYScroll === OrgChart.scroll.visible && (b.yScrollUI.create(b.height(), b.config.padding), b.yScrollUI.setPosition(), b.yScrollUI.addListener(b.getSvg())), b.config.enableSearch && b.searchUI.addSearchControl(), b.toolbarUI.init(b, b.config.toolbar);
            ...
            if (0 < p[0].length) {
                ...
                OrgChart.anim(p[0], p[1], p[2], b.config.anim.duration, b.config.anim.func, function() {
                    g || (x && x(), OrgChart.events.publish("redraw", [b]), b._showAfterAnimation(), g = !0)
                })
            }
            v === OrgChart.action.centerNode ? OrgChart.anim(b.getSvg(), {
                ...
                b.xScrollUI.setPosition(), b.yScrollUI.setPosition(), g || (x && x(), OrgChart.events.publish("redraw", [b]), b._showAfterAnimation(), g = !0)
            }) : !a || !b.response || a[0] == b.response.viewBox[0] && a[1] == b.response.viewBox[1] && a[2] == b.response.viewBox[2] && a[3] == b.response.viewBox[3] || v !== OrgChart.action.insert && v !== OrgChart.action.expandCollapse && v !== OrgChart.action.update && v !== OrgChart.action.init ? 0 == p[0].length && (g || (x && x(), OrgChart.events.publish("redraw", [b]), g = !0)) : OrgChart.anim(b.getSvg(), {
                viewbox: a
            }, {
                viewbox: b.response.viewBox
            }, 500, OrgChart.anim.inOutPow, function() {
                b.xScrollUI.setPosition(), b.yScrollUI.setPosition(), g || (x && x(), OrgChart.events.publish("redraw", [b]), g = !0)
            }), b._initialized = !0
        } else {
            var u = t.boundary,
                C = u.maxX - u.minX,
    ...
    if (null != i) {
        ...
        if (null != a) {
            ...
            C.setAttribute("x", v.ripple.rect ? v.ripple.rect.x : 0), C.setAttribute("y", v.ripple.rect ? v.ripple.rect.y : 0), C.setAttribute("width", v.ripple.rect ? v.ripple.rect.width : i.w), C.setAttribute("height", v.ripple.rect ? v.ripple.rect.height : i.h), C.setAttribute("rx", v.ripple.radius), C.setAttribute("ry", v.ripple.radius), m.setAttribute("clip-path", "url(#" + O + ")"), m.setAttribute("cx", o), m.setAttribute("cy", l), m.setAttribute("r", 0), m.setAttribute("fill", v.ripple.color), u.appendChild(C), f.appendChild(u), f.appendChild(m), a.appendChild(f), OrgChart.anim(m, {
                r: 0,
                opacity: 1
            }, {
                r: p,
    ...
    var r, i, a = t,
        n = !0,
        o = !0;
    e && null != e.parentState && (r = e.parentState), e && null != e.childrenState && (i = e.childrenState), e && null != e.rippleId && (a = e.rippleId), e && null != e.vertical && (n = e.vertical), e && null != e.horizontal && (o = e.horizontal);
    var l = {
        parentState: r,
        childrenState: i,
        rippleId: a,
    ...
    if (this.update(t, e)) {
        var i = t.pid;
        null != i && null != i && "" != i || (i = t.id), this._draw(!1, OrgChart.action.update, {
            id: i
        }, function() {
            r.ripple(t.id)
        })
    ...
    var r = this;
    this.remove(t, e), this._draw(!1, OrgChart.action.update, null, function() {
    ...
    var i = this.getBGNode(t.pid),
        a = t.pid;
    i && i.isChildOfGroup && (a = i._groupParentNodeId), this._draw(!1, r, {
        id: a,
        insertedNodeId: t.id
    })
    ...
    if (r.isGroup || i.isGroup || r.isChildOfGroup || i.isChildOfGroup)
        if (r.isGroup || i.isGroup || !r.isChildOfGroup || i.isChildOfGroup)
            if (r.isGroup || i.isGroup || r.isChildOfGroup || !i.isChildOfGroup) !r.isGroup && !i.isGroup && r.isChildOfGroup && i.isChildOfGroup && (this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), this.removeNodeTag(r.id, r._groupParentNodeId, !0), this.addNodeTag(r.id, i._groupParentNodeId, !0));
            else {
        ...
        this.addTag(o, {
            ...
            template: "group_grey"
        }, !0), this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), this.removeNodeTag(r.id, r._groupParentNodeId, !0), this.addNodeTag(r.id, o, !0), this.addNodeTag(i.id, o, !0);
        var l = this._get(i.id).pid;
        if (r.id != l) this.link(r.id, l);
        else {
            for (var s = this.getBGNode(r._groupParentNodeId), h = (l = "", 0); h < s.bgnodes.length; h++) {
                var d = s.bgnodes[h];
                if (d.id != r.id) {
                    l = d.id;
                    break
        ...
        this.addTag(o, {
            ...
            groupState: OrgChart.EXPAND,
            template: "group_grey"
        }, !0), this.addNodeTag(r.id, o, !0), this.addNodeTag(i.id, o, !0);
        var l = this._get(i.id).pid;
        this.link(r.id, l)
    }
    this._draw(!1, OrgChart.action.update, {
            ...
            for (var e in p[t]) {
                ...
                switch (e.toLowerCase()) {
                    case "d":
                        ...
                        c[t].setAttribute("d", c[t].getAttribute("d") + " L" + a + " " + n);
                        break;
                    case "r":
                    ...
                    case "margin":
                        ...
                        break;
                    default:
                        o = u((10 * v - 10) / f) * (p[t][e] - g[t][e]) + g[t][e], c[t] && c[t].style && (c[t].style[e] = o + r)
                }
            }
    ...
    if (h.innerHTML = "Upload", h.style.position = "absolute", h.style.right = 0, n.style.margin = "0px 14px 0px 14px", n.style.textAlign = "left", n.style.position = "relative", s.style.border = "1px solid #d7d7d7", s.style.backgroundColor = "#d7d7d7", s.style.display = "block", s.style.width = "100%", o.style.floa = "left", o.style.color = "#bcbcbc", l.style.border = "none", l.style.outline = "none", l.style.width = "100%", a && (l.style.width = "80%"), l.style.fontSize = "16px", l.readOnly = i, null != e && null != e && (l.value = e), null != r && null != r && (l.placeholder = r), null != t && null != t && (o.innerHTML = t), o.setAttribute("label", t), l.style.color = "#7a7a7a", i || l.addEventListener("focus", function() {
        ...
        }), n.appendChild(o), n.appendChild(l), a && n.appendChild(h), n.appendChild(s), OrgChart.addValidation) {
        var d = {
            wrapper: n,
            label: o,
            input: l,
    ...
    return "bottom" == a ? n = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2 : "top" == a && (n = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2), e.push([e[e.length - 1][0], n]), e.push([
        [t.x - r.levelSeparation / 3], n
    ]), o = e[e.length - 1][0], s = n, i.p = o, i.q = n, i.s = s, i
}, OrgChart._addPointRight = function(t, e, r, i, a) {
    var n, o = e[e.length - 1][0];
    return "bottom" == a ? n = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2 : "top" == a && (n = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2), e.push([e[e.length - 1][0], n]), e.push([
        [t.x + t.w + r.levelSeparation / 3], n
    ]), o = e[e.length - 1][0], s = n, i.p = o, i.q = n, i.s = s, i
    ...
    o.className = "edit-tags", a.innerHTML = '<svg style="width: 34px; height: 34px;"><path style="fill:#ffffff;" d="M21.205,5.007c-0.429-0.444-1.143-0.444-1.587,0c-0.429,0.429-0.429,1.143,0,1.571l8.047,8.047H1.111 C0.492,14.626,0,15.118,0,15.737c0,0.619,0.492,1.127,1.111,1.127h26.554l-8.047,8.032c-0.429,0.444-0.429,1.159,0,1.587 c0.444,0.444,1.159,0.444,1.587,0l9.952-9.952c0.444-0.429,0.444-1.143,0-1.571L21.205,5.007z"></path></svg>', Object.assign(a.style, {
        ...
        margin: "12px"
    }), this.wrapperElement.appendChild(e), e.appendChild(i), e.appendChild(n), n.appendChild(o), i.appendChild(a), OrgChart.htmlRipple(i);
    var l = this.fields,
    ...
    for (var h = 0; h < l.length; h++) {
        ...
        if (t.isGroup && (d = this.obj.config.tags[t.id]["group" + l[h]]), OrgChart._fieldIsImg(this.obj.config, l[h])) {
            ...
            c.src = d, c.style.width = "100px", c.style.margin = "10px", c.style.borderRadius = "50px", i.appendChild(c)
        } else if ("tags" == l[h]) {
            if (d)
                for (var g = 0; g < d.length; g++) {
                    ...
                    Object.assign(p.style, {
                        ...
                        "user-select": "none"
                    }), p.innerHTML = d[g], o.appendChild(p)
                }
    ...
    }), n.innerHTML = '<div style="float:right"><button type="button" class="btn-primary">Save</button></div>';
    
    var s = OrgChart._arrayContains(this.node.tags, "assistant") ? "checked" : "";
    l.innerHTML = '', this.wrapperElement.appendChild(e), e.appendChild(r), e.appendChild(o), r.appendChild(a), OrgChart.htmlRipple(r);
    var h = this.fields,
    ...
    t.isGroup || t.isChildOfGroup || 0 != t.childrenIds.length || o.appendChild(l), t.isGroup || o.appendChild(n), this.obj.element.appendChild(this.wrapperElement), r.addEventListener("click", function() {
        i.hide(!0)
    }), n.addEventListener("click", function() {
        if ("Save" == n.innerHTML) OrgChart.anim(n, {
            opacity: 1
        }, {
            opacity: 0
        }, 200, OrgChart.anim.inSin, function() {
            n.innerHTML = '<div style="float:right"><button type="button" class="btn-primary">Add</button></div>', n.style.textAlign = "left";
            ...
            if (o.removeChild(t), e && !OrgChart._arrayContains(i.fields, e)) {
                ...
                r.style.opacity = 0, o.insertBefore(r, n), OrgChart.anim(r, {
                    opacity: 0
                }, {
                    opacity: 1
                }, 200, OrgChart.anim.inSin, function() {
            ...
            OrgChart.anim(n, {
                ...
                n.innerHTML = "Save", n.style.textAlign = "right", OrgChart.anim(n, {
                    opacity: 0
                }, {
                    opacity: 1
                }, 200, OrgChart.anim.inSin)
            ...
            t.style.opacity = 0, t.id = "bgNewField", o.appendChild(t), OrgChart.anim(t, {
                opacity: 0
            }, {
                opacity: 1
            }, 200, OrgChart.anim.inSin, function() {
    ...
    if (this.wrapperElement) {
        ...
        if (this.node.isGroup && (e = {
            ...
            for (var r = this.wrapperElement.querySelectorAll("[label]"), i = 0; i < r.length; i++) {
                ...
                if (null != a) {
                    ...
                    if (a === OrgChart.TAGS) e.tags = n.split(",");
                        ...
                        o && e.tags ? OrgChart._arrayContains(this.node.tags, "assistant") || e.tags.push("assistant") : o && !e.tags ? e.tags = ["assistant"] : !o && e.tags && -1 != this.node.tags.indexOf("assistant") && e.tags.splice(e.tags.indexOf("assistant"), 1)
    ...
    for (var i in l || (l = this.menu), l) {
        var a = l[i].icon,
            h = l[i].text;
        void 0 === a && (a = OrgChart.icon[i](24, 24, "#7A7A7A")), "function" == typeof h && (h = h()), "function" == typeof a && (a = a()), r += '<div data-item="' + i + '" style="border-bottom: 1px solid #D7D7D7; padding: 7px 10px;color: #7A7A7A;">' + a + "<span>&nbsp;&nbsp;" + h + "</span></div>"
    }
    if ("" != r) {
        this.wrapper = document.createElement("div"), Object.assign(this.wrapper.style, {
            opacity: 0,
        ...
        var d = t + 45;
        this.wrapper.style.left = d + "px", this.wrapper.style.top = e + "px", this.wrapper.innerHTML = r, this.obj.element.appendChild(this.wrapper), this.wrapper.style.left = d - this.wrapper.offsetWidth + "px";
        var c = t - this.wrapper.offsetWidth;
        OrgChart.anim(this.wrapper, {
            opacity: 0,
            left: d - this.wrapper.offsetWidth
        }, {
            opacity: 1,
            left: c
        }, 300, OrgChart.anim.inOutPow);
        for (var g = this.wrapper.getElementsByTagName("div"), p = 0; p < g.length; p++) {
            (i = g[p]).addEventListener("mouseover", function() {
                ...
                if (void 0 === l[r].onClick)
                ...
                } else "remove" === r ? s.obj.removeNode(n, !0) : "svg" === r ? s.obj.exportSVG({
                    ...
                    expandChildren: !1,
                    nodeId: n
                }) : "csv" === r ? s.obj.exportCSV() : "addInGroup" === r ? s.obj.group(n, o) : "addAsChild" === r && s.obj.linkNode(n, o);
...
}, OrgChart.toolbarUI = function() {}, OrgChart.toolbarUI.prototype.init = function(t, e) {
    if (e) {
        ...
        r && r.addEventListener("click", function() {
            ...
            for (var e = t.target; e;) {
                if (e.hasAttribute("data-layout")) {
                    e = e.getAttribute("data-layout"), o.obj.setLayout(OrgChart[e]);
                    break
                }
                e = e.parentNode
            }
    ...
    var n = this,
        t = {
            id: i.nodeId,
            expandChildren: i.expandChildren
        };
    this._draw(!1, OrgChart.action.exporting, t, function(t) {
        ...
        if (r.innerHTML = t, "svg" == i.ext)
            if (a) a(i, r.innerHTML);
                ...
                if (!1 === e) return !1;
                if (OrgChart._downloadFile(i.mime, r.innerHTML, i.filename), !1 === (e = OrgChart.events.publish("exportend", [n, i, r.innerHTML]))) return !1
            }
            ...
            n._pages(i, r.querySelector("svg"), function(t) {
                ...
                a || OrgChart.loading.show(n), a ? a(n, e, r.querySelector("svg")) : (e = JSON.stringify(e), OrgChart._ajax(n.config.exportUrl + "/v3", "POST", e, "arraybuffer", function(t) {
                    if (!1 === OrgChart.events.publish("exportend", [n, t])) return !1;
                    OrgChart.loading.hide(n), OrgChart._downloadFile(i.mime, t, i.filename)
                }))
            })
        })
    })
}, OrgChart.prototype.exportCSV = function(t) {
    if (t || (t = "OrgChart.csv"), !1 === OrgChart.events.publish("exportstart", [this, "csv", t])) return !1;
    var e = OrgChart._json2csv(this.config.nodes);
    if (!1 === OrgChart.events.publish("exportend", [this, "csv", t, e])) return !1;
    OrgChart._downloadFile("text/csv;charset=utf-8;", e, t)
}, OrgChart.prototype.exportXML = function(t) {
    if (t || (t = "OrgChart.xml"), !1 === OrgChart.events.publish("exportstart", [this, "xml", t])) return !1;
    var e = OrgChart._json2xml(this.config.nodes);
    if (!1 === OrgChart.events.publish("exportend", [this, "xml", t, e])) return !1;
    ...
    var t = {
            id: o.nodeId,
            expandChildren: o.expandChildren
        },
        c = [],
        g = [];
        ...
        this.config.roots = [i.id],
            function(r) {
                s._draw(!1, OrgChart.action.exporting, t, function(t) {
                    var a, n, e = document.createElement("div");
                    e.innerHTML = t, a = e, n = r, OrgChart._imgs2base64(a, "image", "xlink:href", function() {
                        for (var t = a.querySelector("svg"), e = s._pagesAfit(o, t), r = 0; r < e.length; r++) {
                            var i = e[r];
                            i.html = a.innerHTML, c.push(i)
                        }
                        g.length - 1 == n && (s.config.collapse = h, s.config.roots = d, l(c))
                    })
                })
            }(r)
    }
        ...
        this.config.roots = [e],
            function(r) {
                s._draw(!1, OrgChart.action.exporting, t, function(t) {
                    var a, n, e = document.createElement("div");
                    e.innerHTML = t, a = e, n = r, OrgChart._imgs2base64(a, "image", "xlink:href", function() {
                        for (var t = a.querySelector("svg"), e = s._pagesFit(o, t), r = 0; r < e.length; r++) {
                            var i = e[r];
                            i.html = a.innerHTML, c.push(i)
                        }
                        g.length - 1 == n && (s.config.collapse = h, s.config.roots = d, l(c))
    ...
    var l = a[0],
        ...
        d = a[3],
        c = {
            w: t.landscape ? o - (t.margin[1] + t.margin[3]) : n - (t.margin[1] + t.margin[3]),
            h: t.landscape ? n - (t.margin[0] + t.margin[2]) : o - (t.margin[0] + t.margin[2])
        },
        g = {
            w: t.landscape ? o : n,
            h: t.landscape ? n : o
    ...
    return {
        on: function(t, e, r) {
            Array.isArray(o[t]) || (o[t] = []), o[t].push({
                listener: e,
                event_id: r
            })
        },
    ...
    if (this.config.enableDragDrop) {
        ...
        if (c.insertBefore(m, c.firstChild), m.style.opacity = .7, l.isChildOfGroup) {
            ...
            f += n[4], u += n[5], p[4] = f, p[5] = u, m.setAttribute("transform", "matrix(" + p.toString() + ")")
        }
        var O = function(t) {
                var e, r = OrgChart._getClientXY(t),
                    i = document.elementFromPoint(r.x, r.y);
                if (null != s && ((e = d.getBGNode(s)).isChildOfGroup ? (d.getNodeElement(e._groupParentNodeId).style.opacity = 1, h.style.opacity = 1) : e.isGroup || (h.style.opacity = 1)), h = s = null, d.config.enableDragDrop)
                    for (; null != i && i != c;) {
                ...
                null != s && ((e = d.getBGNode(s)).isChildOfGroup ? (d.getNodeElement(e._groupParentNodeId).style.opacity = .8, h.style.opacity = .5) : e.isGroup ? h = s = null : h.style.opacity = .5);
                var n = (r.x - g.x) / C,
                    o = (r.y - g.y) / C;
                p[4] = f + n, p[5] = u + o, m.setAttribute("transform", "matrix(" + p.toString() + ")")
            },
            v = function(t) {
                if (c.removeEventListener(o.move, O), c.removeEventListener(o.up, v), o.leave && c.removeEventListener(o.leave, v), l.id == s || l.isChildOfGroup && l._groupParentNodeId == s || null == s) return c.removeChild(m), void(d._gragStartedId = null);
                var e = d.getBGNode(s);
                if (null == d.config.dragDropMenu || l.isGroup && !e.isGroup) d._canUpdateLink(l.id, s) ? d.linkNode(l.id, s) : c.removeChild(m);
                    ...
                    if (Array.isArray(l.tags))
                        for (var a = 0; a < l.tags.length; a++) {
                            var n = l.tags[a];
                            d.config.tags[n] && d.config.tags[n].dragDropMenu && (i = d.config.tags[n].dragDropMenu)
                        }
                    d.dragDropMenuUI.show(r.x, r.y, l.id, s, i)
                } else c.removeChild(m);
                d._gragStartedId = null
            };
        c.addEventListener(o.move, O), c.addEventListener(o.up, v), o.leave && c.addEventListener(o.leave, v)
    }
    ...
    if (Array.isArray(a.tags))
        for (var o = 0; o < a.tags.length; o++) {
            var l = a.tags[o];
            this.config.tags[l] && this.config.tags[l].nodeMenu && (n = this.config.tags[l].nodeMenu)
        }
    ...
    var t = new OrgChart.node(OrgChart._randomId(), null, null, [], this.config.template);
...
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.node = function(t, e, r, i, a) {
    this.templateName = a, this.id = t, this.pid = e, this.spids = Array.isArray(r) ? r : null, this.x = null, this.y = null, this.level = null, this.leftNeighbor = null, this.rightNeighbor = null, this._prelim = 0, this._modifier = 0, this.children = [], this.parent = null, this.isAssistant = !1, this.tags = i, this.collapsedChildrenIds = [], this.childrenIds = [];
    var n = OrgChart.t(this.templateName);
    this.w = n && n.size ? n.size[0] : 0, this.h = n && n.size ? n.size[1] : 0, this.groupState = OrgChart.EXPAND, this.isChildOfGroup = !1, this.isGroup = !1, this._groupParentNodeId = null, this._groupSettings = null, this.bgnodes = []
    ...
    var p = function(t) {
        ...
        f = function() {
            ...
            }), c = null, n.style.display = "none", t.removeEventListener(r.move, p), t.removeEventListener(r.up, f), r.leave && t.removeEventListener(r.leave, f), r.touchstart && t.removeEventListener(r.touchstart, f)
        };
    ...
    for (var e = [], a = [], n = [t.orientation, t.levelSeparation, t.mixedHierarchyNodesSeparation, t.subtreeSeparation, t.siblingSeparation, t.template], o = 0; o < r.length; o++) a.push(r[o].id), OrgChart.remote._toReqDTO(r[o], e, t.template);
    var l = {
        n: e,
        c: n,
        r: a,
    ...
    OrgChart.LIMIT_NODES || (l.l = !0), null != OrgChart.remote._fromReqDTO ? OrgChart.remote._fromReqDTO(l.n, l.r, l.c, function(t) {
        ...
        i()
    }) : (l = JSON.stringify(l).replace(/\"([^(\")"]+)\":/g, "$1:"), OrgChart.idb.read(l, function(t, e) {
    ...
    return OrgChart._browser().msie ? OrgChart.remote[t] : localStorage.getItem(t)
}, OrgChart.remote.setItem = function(t, e) {
    OrgChart._browser().msie ? OrgChart.remote[t] = e : localStorage.setItem(t, e)
    ...
    e.addEventListener("mouseover", function() {
        ...
        40 == t.keyCode ? n() : 38 == t.keyCode ? o() : 13 == t.keyCode ? l() : 27 == t.keyCode ? r.hide() : r._serverSearch(this.value)
    });
    var n = function() {
    ...
    if (t) {
        ...
        a != OrgChart.action.exporting && (this.maxX = h, this.maxY = d, this.minX = c, this.minY = g, this.root = p, this.nodes = f, this.groupChildren = u, this.visibleNodes = C.visibleNodes), o(C)
        ...
        e.notif = t.limit, a != OrgChart.action.exporting && (s.maxX = h, s.maxY = d, s.minX = c, s.minY = g, s.root = p, s.nodes = f, s.groupChildren = u, s.visibleNodes = e.visibleNodes), o(e)
    }, l)
}, OrgChart.server.prototype._read = function(a, t) {
    var n = this,
        o = OrgChart.server._createNodes(this.config, this.action, this.actionParams, this.oldNodes);
    t(o);
    var l = o.nodes,
        s = o.roots,
        e = OrgChart.remote;
    null == e && (e = OrgChart.local), e._walk(s, this.config, function(t) {
        OrgChart.server._doNotChangePositionOfClickedNodeIfAny(s, l, n.action, n.actionParams, n.oldNodes, n.config.orientation);
        var e = {
            minX: null,
            minY: null,
            maxX: null,
    ...
    for (var e, i, a, n = function(t) {
            for (var e in r.config.nodeBinding)
                if (r.config.nodeBinding[e] == t) return !0;
            return !1
        }, o = [], l = [], s = 0; s < this.config.nodes.length; s++) {
        var h = this.config.nodes[s];
        for (var d in h) {
            var c = h[d];
            0 < this.config.searchFields.length && -1 == this.config.searchFields.indexOf(d) || c && -1 != OrgChart.accentFold(c).indexOf(t) && !OrgChart._fieldIsImg(this.config, d) && o.push({
                id: h.id,
                propertyName: d,
                isId: d == OrgChart.ID,
                isNodeParam: n(d),
    ...
    for (s = 0; s < o.length && 10 != s; s++) {
        ...
        if (!g) {
            ...
            for (p = 0; p < O.length; p++) {
                d = O[p], c = o[s].data[d];
                d === o[s].propertyName && (e = c, i = t, void 0, a = OrgChart.accentFold(e).indexOf(i), c = e.toString().splice(a + i.length, 0, "</mark>").splice(a, 0, "<mark>")), d != OrgChart.TAGS && (d == OrgChart.ID ? u = u + c + ", " : OrgChart._fieldIsImg(this.config, d) ? m = c : n(d) && !OrgChart._fieldIsImg(this.config, d) ? f = f + c + ", " : OrgChart._fieldIsImg(this.config, d) || (C = C + c + ", "))
            }
    ...
    for (var a = t.nodes, n = {}, o = [], l = [], s = [], h = {}, d = !1, c = 0; c < a.length; c++) {
        var g = a[c],
        ...
        if ((y = new OrgChart.node(g.id, g.pid, C, p, u)).isAssistant = -1 != p.indexOf("assistant"), y.isAssistant && -1 == s.indexOf(y.pid) && s.push(y.pid), null != f) {
            if (!n[f.name]) {
                o.push(f.name);
                var m = new OrgChart.node(f.name, g.pid, null, [f.name], f.tag.template);
                m.isGroup = !0, null != t.orderBy && (m.order = g[t.orderBy]), n[f.name] = m
            }
            y.isChildOfGroup = !0, y._groupParentNodeId = f.name, n[f.name].bgnodes.push(y), 1 == y.isAssistant && (n[f.name].isAssistant = !0), h[y.id] = f.name, d = !0
        } else null != t.orderBy && (y.order = g[t.orderBy]), n[g.id] = y, o.push(g.id)
    }
    if (null != t.orderBy && o.sort(function(t, e) {
            var r = n[t].order,
                i = n[e].order;
    ...
    for (c = 0; c < o.length; c++) {
        var v = o[c],
            y = n[v],
            x = i ? i[v] : null;
        if (null != y.pid && null != y.pid && "" !== y.pid)(_ = n[y.pid]) ? ((y.parent = _).children.push(y), _.childrenIds.push(y.id)) : (y.pid = null, y.parent = null, l.push(y));
        else l.push(y);
        e == OrgChart.action.exporting && null != r.id && (l = [n[r.id]]), x ? (y.state = x.state, y.state == OrgChart.COLLAPSE && O.push(y.id), OrgChart.server._setNodeGroupState(y, x.groupState, t.orientation)) : OrgChart.server._setNodeGroupState(y, OrgChart.EXPAND, t.orientation), OrgChart.server._initStates(y, n, e, t, r, O), OrgChart.server._initGroupStates(y, n, e, t, r)
    }
    if (null != t.roots) {
        l = [];
            ...
            if (b) {
                if (b.parent)
                    for (var w = (_ = b.parent).children.length - 1; 0 <= w; w--) {
                        (U = _.children[w]) == b && (U.parent = null, _.children.splice(w, 1), _.childrenIds.splice(w, 1))
                    }
                l.push(b)
            }
        }
    ...
    for (c = 0; c < s.length; c++) {
        ...
        (n[k.id] = k).isAssistant = !0, (x = i[k.id]) && (n[k.id].state = x.state, n[k.id].state == OrgChart.COLLAPSE && O.push(k.id)), OrgChart.server._initStates(k, n, e, t, r, O);
        var A = [];
        for (w = _.children.length - 1; 0 <= w; w--) {
            (U = _.children[w]).isAssistant ? (U.parent = null, _.children.splice(w, 1), _.childrenIds.splice(w, 1), A.splice(0, 0, U.id)) : (U.pid = k.id, (U.parent = k).children.push(U), k.childrenIds.push(U.id), _.children.splice(w, 1))
        }
        if (A.length % 2) {
            ...
            OrgChart.templates[N] = {
                ...
                nodeMenuButton: "",
                size: I
            }, (W = new OrgChart.node(_.id + "_transperant", S.pid, null, [], N)).isAssistant = !0, n[W.id] = W, A.splice(A.length - 1, 0, W.id)
        }
        var M = 1;
        for (w = A.length - 1; 0 <= w; w--) {
            if (w % 2 && w != A.length - 1)(J = new OrgChart.node(_.id + "_split_" + M, null, null, [], "split")).isAssistant = !0, n[J.id] = J, A.splice(w, 0, J.id), M++;
        ...
        for (w = 0; w < A.length; w += 3) {
            ...
            var L = n[A[w]],
                B = n[A[w + 1]],
                T = n[A[w + 2]];
            L.parent = E, L.pid = E.id, B.parent = E, B.pid = E.id, T.parent = E, T.pid = E.id, E.children.push(L), E.children.push(B), E.children.push(T), E.childrenIds.push(L.id), E.childrenIds.push(B.id), E.childrenIds.push(T.id);
            for (var H = E;
                "split" == H.templateName && (H = H.parent);) H.childrenIds.push(L.id), H.childrenIds.push(B.id), H.childrenIds.push(T.id)
        }
    }
    if (e == OrgChart.action.centerNode) {
        var P = n[r.id];
        P || (P = n[h[r.id]], OrgChart.server._setNodeGroupState(P, OrgChart.EXPAND, t.orientation)), P.state = OrgChart.EXPAND, -1 != (D = O.indexOf(P.id)) && O.splice(D, 1);
        _ = OrgChart.server._getRealParent(P);
        for (var z = P.id; null != _;) {
            if (-1 != (D = O.indexOf(_.id)) && O.splice(D, 1), _.state = OrgChart.EXPAND, r.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS)
                for (c = 0; c < _.childrenIds.length; c++) {
                    var U = n[_.childrenIds[c]];
                    if (!OrgChart.server._isSplit(U) && !U.isAssistant && U.id != z) - 1 == (D = O.indexOf(_.childrenIds[c])) && O.push(_.childrenIds[c]), U.state = OrgChart.COLLAPSE
                }
            if (_.state == OrgChart.EXPAND)
                for (var F = 0; F < _.childrenIds.length; F++) {
                    var j = n[_.childrenIds[F]];
                    if (OrgChart.server._isSplit(j) || j.isAssistant) - 1 != (D = O.indexOf(j.id)) && O.splice(D, 1), j.state = OrgChart.EXPAND
                }
        ...
        if (r.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
            for (c = 0; c < P.childrenIds.length; c++) {
                if (-1 != (D = O.indexOf(P.childrenIds[c])) && O.splice(D, 1), (U = n[P.childrenIds[c]]).state = OrgChart.EXPAND, !U.isAssistant && !OrgChart.server._isSplit(U))
                    for (w = 0; w < U.childrenIds.length; w++) {
                        var D, G = n[U.childrenIds[w]]; - 1 == (D = O.indexOf(U.childrenIds[w])) && O.push(U.childrenIds[w]), G.state = OrgChart.COLLAPSE
                    }
            }
    }
    ...
    for (c = 0; c < O.length; c++) {
        if (_ = (y = n[O[c]]).parent)
            for (w = _.children.length - 1; 0 <= w; w--) {
                if (_.children[w] == y)
                    if (-1 == _.collapsedChildrenIds.indexOf(y.id) && _.collapsedChildrenIds.push(y.id), _.children.splice(w, 1), "split" == y.templateName || "split" == _.templateName) {
                        if (E = y.parent) {
                            for (;
                                "split" == E.templateName;) E = E.parent;
                            for (var R = 0; R < E.childrenIds.length; R++) {
                                var X = E.childrenIds[R]; - 1 == E.collapsedChildrenIds.indexOf(X) && E.collapsedChildrenIds.push(X)
                            }
                        }
                    } else y.parent = null
            }
    ...
    if (t.layout == OrgChart.mixed)
        for (c = 0; c < o.length; c++) {
            if (0 == (y = n[o[c]]).childrenIds.length && !y.isAssistant && "split" != y.templateName)
                if (_ = y.parent) {
                    if (!OrgChart.server._mixedLayoutAllNodes(_)) continue;
                    for (w = _.children.length - 1; 0 <= w; w--) {
                        if ((U = _.children[w]) != y && 0 == U.childrenIds.length && !U.isAssistant && "split" != U.templateName) {
                            U.parent = y, U.pid = y.id, U.layout = OrgChart.mixed, _.children.splice(w, 1);
    ...
    if (t.layout == OrgChart.tree || t.layout == OrgChart.treeRightOffset || t.layout == OrgChart.treeLeftOffset) {
        var q = [];
        for (c = 0; c < o.length; c++) {
            if (0 == (y = n[o[c]]).childrenIds.length && !y.isAssistant && "split" != y.templateName)(_ = y.parent) && -1 == q.indexOf(_.id) && q.push(_.id)
        }
        for (c = 0; c < q.length; c++) {
            _ = n[q[c]], k = new OrgChart.node(_.id + "_split_0", _.id, null, [], "split");
            (n[k.id] = k).layout = OrgChart.tree;
            var V = [];
            for (w = _.children.length - 1; 0 <= w; w--) {
                if (OrgChart.server._mixedLayoutAllNodes(_))
                    if (0 == (U = _.children[w]).childrenIds.length && !U.isAssistant && "split" != U.templateName && (U.parent && "split" != U.parent.templateName || U.parent.isAssistant)) {
                        if ((U = _.children[w]).parent = null, U.layout = OrgChart.tree, _.children.splice(w, 1), _.childrenIds.splice(w, 1), t.layout == OrgChart.treeRightOffset && V.splice(0, 0, U.id), t.layout == OrgChart.treeLeftOffset || t.layout == OrgChart.treeRightOffset) {
                            var W;
                            ...
                            OrgChart.templates[N] = {
                                ...
                                nodeMenuButton: "",
                                size: [0, 0]
                            }, (W = new OrgChart.node(U.id + "_transperant", null, null, [], N)).layout = OrgChart.tree, n[W.id] = W, V.splice(0, 0, W.id)
                        }
            ...
            for (M = 1, w = V.length - 1; 0 <= w; w--) {
                var J;
                if (w % 2 && w != V.length - 1)(J = new OrgChart.node(_.id + "_split_" + M, null, null, [], "split")).layout = OrgChart.tree, n[J.id] = J, V.splice(w, 0, J.id), M++;
            ...
            for (w = 0; w < V.length; w += 3) {
                ...
                0 != w && (E = n[V[w - 3]]), 0 == w || B || (E = n[V[w - 2]]), L.parent = E, L.pid = E.id, E.children.push(L), _.childrenIds.push(L.id), B && (0 != w && (E = n[V[w - 2]]), B.parent = E, B.pid = E.id, E.children.push(B), _.childrenIds.push(B.id)), T && (0 != w && (E = n[V[w - 1]]), T.parent = E, T.pid = E.id, E.children.push(T), _.childrenIds.push(T.id))
            }
        }
    }
    return {
    ...
    if (r == OrgChart.action.init && t) {
        if (t.tags)
            for (var o = 0; o < t.tags.length; o++) {
                var l = t.tags[o];
                i.tags && i.tags[l] && null != i.tags[l].state && (i.tags[l].state == OrgChart.COLLAPSE && n.push(t.id), t.state = i.tags[l].state)
            }
        ...
        -1 != (s = n.indexOf(t.id)) && n.splice(s, 1), t.state = OrgChart.EXPAND, OrgChart.server._expandCollapseToLevel(t, e, r, i, a, n)
        ...
        if (a.state == OrgChart.COLLAPSE) n.push(t.id);
            ...
            var s; - 1 != (s = n.indexOf(t.id)) && n.splice(s, 1)
        }
        t.state = a.state
    }
    ...
    if (i.collapse.level) {
        ...
        if (o >= i.collapse.level) {
            ...
            if (Array.isArray(i.expand.nodes))
                ...
                !s && i.collapse.allChildren ? (n.push(t.id), t.state = OrgChart.COLLAPSE) : s || i.collapse.allChildren || o != i.collapse.level || (n.push(t.id), t.state = OrgChart.COLLAPSE)
        }
    }
    ...
    if (t.isGroup && t.groupState == OrgChart.EXPAND) {
        ...
        if (0 == i.layout_type) switch (r) {
            ...
            case OrgChart.orientation.bottom_left:
                l = 1, s = o;
                for (var c = 0; c < t.bgnodes.length; c++) h = Math.max(t.bgnodes[c].w, h), d = Math.max(t.bgnodes[c].h, d), n += t.bgnodes[c].h + i.groupNodesSeparation;
            ...
            case OrgChart.orientation.bottom_left:
                ...
                a = h * l + i.groupNodesSeparation * l + i.groupNodesSeparation + i.groupPadding[1] + i.groupPadding[3], n = d * s + i.groupNodesSeparation * s + i.groupNodesSeparation + i.groupPadding[0] + i.groupPadding[2];
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.left:
            case OrgChart.orientation.right_top:
        ...
        if (0 == r.layout_type) switch (e) {
            ...
            case OrgChart.orientation.bottom_left:
                for (var n = 0, o = 0; o < t.bgnodes.length; o++) {
                    (s = t.bgnodes[o]).x = t._groupSettings._cellWidth / 2 - s.w / 2, s.y = t._groupSettings._cellHeight / 2 - s.h / 2 + n, n += s.h + r.groupNodesSeparation
                }
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.left:
            ...
            case OrgChart.orientation.left_top:
                ...
                for (o = 0; o < t.bgnodes.length; o++) {
                    (s = t.bgnodes[o]).y = t._groupSettings._cellHeight / 2 - s.h / 2, s.x = t._groupSettings._cellWidth / 2 - s.w / 2 + l, l += s.w + r.groupNodesSeparation
                }
        } else
            for (o = 0; o < t.bgnodes.length; o++) {
                var s;
                (s = t.bgnodes[o]).x = t._groupSettings._cellWidth / 2 - s.w / 2 + r.groupNodesSeparation + (t._groupSettings._cellWidth * i + r.groupNodesSeparation * i), s.y = t._groupSettings._cellHeight / 2 - s.h / 2 + r.groupNodesSeparation + (t._groupSettings._cellHeight * a + r.groupNodesSeparation * a), i >= t._groupSettings._columns - 1 ? (i = 0, a++) : i++
            }
    }
    ...
    if (C.top = l - i.padding, C.left = o - i.padding, C.bottom = n + i.padding - e / y, C.right = a + i.padding - t / y, C.maxX = a, C.minX = o, C.maxY = n, C.minY = l, null == s && i.align == OrgChart.CENTER) {
        var x = Math.ceil(t / y),
            b = Math.ceil(e / y),
            w = 0,
            _ = 0;
        ...
        if (b - 2 * i.padding >= n - l) switch (_ = (n + l) / 2 - b / 2, i.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
                _ = (l - n) / 2 - b / 2
        } else switch ((_ = -(b / 2 - (n - l) / 2)) > -i.padding && (_ = -i.padding), i.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
    ...
    node: '<rect x="0" y="0" height="120" width="265" fill="none" stroke-width="1" stroke="#aeaeae"></rect>',
    ...
    assistanseLink: '<path stroke-linejoin="round" stroke="#aeaeae" stroke-width="2px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} {xd},{yd} L{xe},{ye}"/>',
    pointer: '<g data-pointer="pointer" transform="matrix(0,0,0,0,100,100)"><radialGradient id="pointerGradient"><stop stop-color="#ffffff" offset="0" /><stop stop-color="#C1C1C1" offset="1" /></radialGradient><circle cx="16" cy="16" r="16" stroke-width="1" stroke="#acacac" fill="url(#pointerGradient)"></circle></g>',
    node: '<rect x="0" y="0" height="120" width="265" fill="#039BE5" stroke-width="1" stroke="#aeaeae" rx="5" ry="5"></rect>',
    plus: '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#aeaeae" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#aeaeae"></line>',
    minus: '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#aeaeae" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line>',
    nodeMenuButton: '<g style="cursor:pointer;" transform="matrix(1,0,0,1,225,105)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>',
    exportMenuButton: '<div style="position:absolute;right:{p}px;top:{p}px; width:40px;height:50px;cursor:pointer;" control-export-menu=""><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"></div>',
    ...
    field_0: '<text width="230" class="field_0"  style="font-size: 14px;" fill="#ffffff" x="125" y="95" text-anchor="middle">{val}</text>',
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        if (d.defs && (c = c.replace("{randId}", OrgChart.ui._defsIds[t.templateName])), null == o && (o = i.nodeBinding), t.isGroup) {
            var g = i.tags[t.id].groupName;
            if (g) g = OrgChart._wrapText(g, d.groupName), c += u = (u = d.groupName.replace("{val}", g)).replaceAll("{randId}", OrgChart._randomId()).replaceAll("{randId2}", OrgChart._randomId());
            c += u
        } else
            for (var p in o) {
                var f = o[p];
                if (e) {
                    var u, C = e[f];
                    if ("function" == typeof f && (C = f(h, t)), null != C && null != C && null != d[p]) c += u = (u = (OrgChart._lblIsImg(i, p) || "string" != typeof C || (C = OrgChart._wrapText(C, d[p])), d[p].replace("{val}", C))).replaceAll("{randId}", OrgChart._randomId()).replaceAll("{randId2}", OrgChart._randomId())
                }
            }
    ...
    expandCollapse: function(t, e, r, i) {
        ...
        return n -= l.expandCollapseSize / 2, o -= l.expandCollapseSize / 2, t.collapsedChildrenIds.length ? (a += OrgChart.expcollOpenTag.replace("{id}", t.id).replace("{x}", n).replace("{y}", o), a += l.plus) : (a += OrgChart.expcollOpenTag.replace("{id}", t.id).replace("{x}", n).replace("{y}", o), a += l.minus), a += OrgChart.grCloseTag
    },
        ...
        for (var n = "", o = 0; o < e.spids.length; o++) {
            ...
            if (t[s]) {
                ...
                var c = OrgChart.t(e.templateName, a),
                    g = r.levelSeparation;
                (e.parent && e.parent.layout == OrgChart.mixed || e.parent.layout == OrgChart.tree) && (g = r.mixedHierarchyNodesSeparation);
                var p = {
                ...
                switch (r.orientation) {
                    ...
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        p.q = e.y + e.h, p.s = i.maxY - g, l.push([p.p, p.q]), l.push([p.r, e.y + e.h + g / 3]);
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        p.p = e.x, p.q = e.y + e.h / 2 + c.expandCollapseSize, p.r = i.minX - g, p.s = e.y + e.h / 2 + c.expandCollapseSize, l.push([p.p, p.q]), l.push([e.x - g / 3, p.q]);
                        break;
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        p.p = e.x + e.w, p.q = e.y + e.h / 2 + c.expandCollapseSize, p.r = i.maxX + g, p.s = e.y + e.h / 2 + c.expandCollapseSize, l.push([p.p, p.q]), l.push([e.x + e.w + g / 3, p.q])
                }
                for (var f = e; null == h;) {
                    var u = !1,
                        C = f.parent,
                        m = C.leftNeighbor,
                        O = C.rightNeighbor;
                    if (C.id == s ? h = C : OrgChart._intersects(C, p, r) && (p = OrgChart._addPoint(C, l, r, p, d), u = !0), C.id != s) {
                        for (; m;) {
                            if (m.id == s) {
                                h = m;
                                break
                            }
                            OrgChart._intersects(m, p, r) && (p = OrgChart._addPoint(m, l, r, p, d), u = !0), m = m.leftNeighbor
                        }
                        for (; O;) {
                            if (O.id == s) {
                                h = O;
                            ...
                            OrgChart._intersects(O, p, r) && (p = OrgChart._addPoint(O, l, r, p, d), u = !0), O = O.rightNeighbor
                        }
                    }
                    if (!u) {
                        var v = l[l.length - 1][0],
                            y = 0;
                        if (C.parent) switch (g = r.levelSeparation, C.parent.layout != OrgChart.mixed && C.parent.layout != OrgChart.tree || (g = r.mixedHierarchyNodesSeparation), r.orientation) {
                            case OrgChart.orientation.top:
                            case OrgChart.orientation.top_left:
                            ...
                            case OrgChart.orientation.left:
                            case OrgChart.orientation.left_top:
                                v = C.parent.x + C.parent.w + g * (2 / 3), y = l[l.length - 1][1];
                                break;
                            case OrgChart.orientation.right:
                            case OrgChart.orientation.right_top:
                ...
                switch (c = OrgChart.t(h.templateName, a), l.splice(l.length - 1, 1), r.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                        l.push([h.x + h.w / 2 + c.expandCollapseSize, l[l.length - 1][1]]), l.push([l[l.length - 1][0], h.y + h.h]);
                        break;
                    case OrgChart.orientation.bottom:
                    case OrgChart.orientation.bottom_left:
                        l.push([h.x + h.w / 2 + c.expandCollapseSize, l[l.length - 1][1]]), l.push([l[l.length - 1][0], h.y]);
                        break;
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top:
                        l.push([l[l.length - 1][0], h.y + h.h / 2 + c.expandCollapseSize]), l.push([h.x + h.w, l[l.length - 1][1]]);
                        break;
                    case OrgChart.orientation.right:
                    case OrgChart.orientation.right_top:
                        l.push([l[l.length - 1][0], h.y + h.h / 2 + c.expandCollapseSize]), l.push([h.x, l[l.length - 1][1]])
                }
                l[0] = "M" + l[0].join(",");
                for (var x = 1; x < l.length; x++) l[x] = "L" + l[x].join(",");
                l = l.join(" "), n += OrgChart.secondLinkOpenTag.replace("{id}", e.id).replace("{child-id}", s) + c.secondLink.replace("{d}", l), n += OrgChart.grCloseTag
            }
        }
        return n
    },
    link: function(t, e, r, i) {
        ...
        t.layout != OrgChart.mixed && t.layout != OrgChart.tree || (o = r.mixedHierarchyNodesSeparation / 2);
        for (var l = 0; l < t.children.length; l++) {
            ...
            d = d.replace("{xa}", h.xa).replace("{ya}", h.ya).replace("{xb}", h.xb).replace("{yb}", h.yb).replace("{xc}", h.xc).replace("{yc}", h.yc).replace("{xd}", h.xd).replace("{yd}", h.yd), n.push(OrgChart.linkOpenTag.replace("{id}", t.id).replace("{class}", "link " + s.tags.join(" ")).replace("{level}", t.level).replace("{child-id}", s.id)), n.push(d);
            var c = "";
            ...
            "" != c && (c = OrgChart.linkFieldsOpenTag.replace("{x}", h.x).replace("{y}", h.y).replace("{rotate}", 0) + c + OrgChart.grCloseTag, n.push(c)), n.push(OrgChart.grCloseTag)
        }
        return n.join("")
    },
    svg: function(t, e, r, i, a, n) {
        return OrgChart.t(i.template, n).svg.replace("{w}", t).replace("{h}", e).replace("{viewBox}", r).replace("{content}", a)
    },
    ...
    _linkTopToBottom: function(t, e, r, i) {
        var a, n, o, l, s, h, d, c = 0;
        return a = t.x + t.w / 2 + r.linkAdjuster.toX, n = t.y + t.h + r.linkAdjuster.toY, s = l = e.x + e.w / 2 + r.linkAdjuster.fromX, h = e.y + r.linkAdjuster.fromY, {
            xa: o = a,
            ya: n,
            xb: o,
            yb: c = t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.y + t.rightNeighbor.h + i : "split" != t.templateName || !e.isAssistant && 2 != e.layout ? "split" == e.templateName ? n + i : h - i : h,
            xc: d = l,
            yc: c,
            xd: s,
            yd: h,
    ...
    _linkBottomToTop: function(t, e, r, i) {
        var a, n, o, l, s, h, d, c = 0;
        return a = t.x + t.w / 2 + r.linkAdjuster.toX, n = t.y + r.linkAdjuster.toY, s = l = e.x + e.w / 2 + r.linkAdjuster.fromX, h = e.y + e.h + r.linkAdjuster.fromY, {
            xa: o = a,
            ya: n,
            xb: o,
            yb: c = t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.y - i : "split" != t.templateName || !e.isAssistant && 2 != e.layout ? "split" == e.templateName ? n - i : h + i : h,
            xc: d = l,
            yc: c,
            xd: s,
            yd: h,
    ...
    _linkRightToLeft: function(t, e, r, i) {
        var a, n, o, l, s, h, d, c = 0;
        return a = t.x + r.linkAdjuster.toX, n = t.y + t.h / 2 + r.linkAdjuster.toY, s = e.x + e.w + r.linkAdjuster.fromX, h = l = e.y + e.h / 2 + r.linkAdjuster.fromY, {
            xa: a,
            ya: o = n,
    ...
    _linkLeftToRight: function(t, e, r, i) {
        var a, n, o, l, s, h, d, c = 0;
        return a = t.x + t.w + r.linkAdjuster.toX, n = t.y + t.h / 2 + r.linkAdjuster.toY, s = e.x + r.linkAdjuster.fromX, h = l = e.y + e.h / 2 + r.linkAdjuster.fromY, {
            xa: a,
            ya: o = n,
    ...
    if (!t && i === OrgChart.match.boundary) return (o = r / n) < (l = e / a) ? o : l;
...
//         u.setAttributeNS(null, "x", a), u.setAttributeNS(null, "y", n), u.setAttributeNS(null, "text-anchor", o), u.appendChild(C), d.appendChild(u);
//         g = 1;
//         for (var m = 1; m < p.length; m++) {
//             var O = u.firstChild.data.length;
//             if (u.firstChild.data += " " + p[m], u.getComputedTextLength() > l) u.firstChild.data = u.firstChild.data.slice(0, O), (u = document.createElementNS(h, "tspan")).setAttributeNS(null, "x", a), u.setAttributeNS(null, "y", n + f * g), u.setAttributeNS(null, "text-anchor", o), C = document.createTextNode(p[m]), u.appendChild(C), d.appendChild(u), g++
//         }
//         var v = "";
//         if (null != d.innerHTML) v = d.innerHTML, d.innerHTML = "";
//         else {
//             var y = "";
//             for (m = d.childNodes.length - 1; 0 <= m; m--) y = XMLSerializer().serializeToString(d.childNodes[m]) + y, d.removeChild(d.childNodes[m]);
//             v = y
//         }
//         return v
//     }
...
, OrgChart._downloadFile = function(t, e, r) {
    ...
    if (navigator.msSaveBlob) navigator.msSaveBlob(i, r);
        ...
        if (void 0 !== a.download) {
            ...
            a.setAttribute("href", n), a.setAttribute("download", r), a.style.visibility = "hidden", document.body.appendChild(a), a.click(), document.body.removeChild(a)
        }
    }
    ...
    var l = this;
    this.config.mouseScrool == OrgChart.action.xScroll && this.bar && function(t, i, e) {
        var a = !1;

        function r(t) {
            t.preventDefault();
            var e = t.delta || t.wheelDelta;
            void 0 === e && (e = -t.detail), e = Math.max(-1, Math.min(1, e)), l.pos += -e * i;
            var r = parseFloat(l.innerBar.clientWidth) - parseFloat(l.bar.clientWidth);
        ...
        function n() {
            ...
            0 < t ? t++ : t--, l.bar.scrollLeft += t, l.bar.scrollLeft == l.pos ? a = !1 : o(n)
        }
        t.addEventListener("mousewheel", r, !1), t.addEventListener("DOMMouseScroll", r, !1);
    ...
    var a = this;
    this.bar && this.bar.parentNode.removeChild(this.bar), this.bar = document.createElement("div"), this.innerBar = document.createElement("div");
    this.requestParams();
    ...
    var l = this;
    this.config.mouseScrool == OrgChart.action.yScroll && this.bar && function(t, i, e) {
        var a = !1;
        ...
        function r(t) {
            ...
            var e = t.delta || t.wheelDelta;
            void 0 === e && (e = -t.detail), e = Math.max(-1, Math.min(1, e)), l.pos += -e * i;
            var r = parseFloat(l.innerBar.clientHeight) - parseFloat(l.bar.clientHeight);
            l.pos < 0 && (l.pos = 0), l.pos > r && (l.pos = r), a || n()
        }
        ...
        function n() {
            ...
            0 < t ? t++ : t--, l.bar.scrollTop += t, l.bar.scrollTop == l.pos ? a = !1 : o(n)
        }
        t.addEventListener("mousewheel", r, !1), t.addEventListener("DOMMouseScroll", r, !1);
        var o = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
            setTimeout(t, 20)
    ...
    var a = this;
    this.bar && this.bar.parentNode.removeChild(this.bar), this.bar = document.createElement("div"), this.innerBar = document.createElement("div"), this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, {
        position: "absolute",
        right: 0,
        bottom: 0,
        height: t + "px",
    ...
    var a, n, o, l = r.element.querySelector("#bg-ppdf-size"),
    ...
    for (var e, r, i, a, n, o = "", l = 0; l < this.config.clinks.length; l++) {
        ...
        if (h && d) {
            ...
            switch (this.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    p <= f ? (m = 1, c.x = p + h.w / 10, g.x = f - d.w / 10) : (m = -1, c.x = p - h.w / 10, g.x = f + d.w / 10), h.y == d.y ? (m = 1, c.y = h.y, g.y = d.y) : h.y > d.y ? (c.y = h.y, g.y = d.y + d.h) : (c.y = h.y + h.h, g.y = d.y);
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    c.x = p <= f ? (m = -1, p + h.w / 10) : (m = 1, p - h.w / 10), g.x = f + d.w / 10, h.y == d.y ? (m = -1, c.y = h.y + h.h, g.y = d.y + d.h) : h.y > d.y ? (c.y = h.y, g.y = d.y + d.h) : (c.y = h.y + h.h, g.y = d.y);
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    c.y = u <= C ? (m = -1, u + h.h / 5) : (m = 1, u - h.h / 5), g.y = C + d.h / 5, h.x == d.x ? (m = -1, c.x = h.x, g.x = d.x) : h.x > d.x ? (c.x = h.x, g.x = d.x + d.w) : (c.x = h.x + h.w, g.x = d.x);
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    c.y = u <= C ? (m = 1, u + h.h / 5) : (m = -1, u - h.h / 5), g.y = C + d.h / 5, h.x == d.x ? (m = 1, c.x = h.x + h.w, g.x = d.x + d.w) : h.x > d.x ? (c.x = h.x, g.x = d.x + d.w) : (c.x = h.x + h.w, g.x = d.x)
            }
            var O = b(c, g, m),
                v = s.template;
            v || (v = "orange");
            var y = OrgChart.clinkTemplates[v];
            o += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", h.id).replace("{to}", d.id) + y.link.replace("{d}", "M{a.x},{a.y} C{a.x},{a.y} {c.x},{c.y} {b.x},{b.y}").replaceAll("{b.x}", g.x).replaceAll("{b.y}", g.y).replaceAll("{a.x}", c.x).replaceAll("{a.y}", c.y).replaceAll("{c.x}", O.x).replaceAll("{c.y}", O.y);
            var x = (e = c, i = O, void 0, a = ((r = g).x - e.x) / 2 + e.x, n = (r.y - e.y) / 2 + e.y, {
                x: (a - i.x) / 2 + i.x,
                y: (n - i.y) / 2 + i.y
            });
            s.label && (o += y.label.replace("{x}", x.x).replace("{y}", x.y).replace("{val}", s.label)), o += OrgChart.grCloseTag
        }
