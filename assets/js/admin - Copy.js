...
function initiativeBar() {
    ...
    if (!($body.hasClass('submenu-closed')) && !($body.hasClass('side-closed'))) {
        $('#initiative_sidebar').css('left', '244px');
        $('#section').css('margin-top', '34px');
        $('#section').css('margin-right', '15px');
        $('#section').css('margin-bottom', '0');
        $('#section').css('margin-left', '502px');
    } else if (($body.hasClass('submenu-closed')) && !($body.hasClass('side-closed')) && !($body.hasClass('side-closed-hover'))) {
        $('#initiative_sidebar').css('left', '244px');
        $('#section').css('margin-top', '34px');
        $('#section').css('margin-right', '15px');
        $('#section').css('margin-bottom', '0');
        $('#section').css('margin-left', '502px');
    } else if (($body.hasClass('side-closed-hover')) && !($body.hasClass('side-closed')) && !($body.hasClass('submenu-closed'))) {
        $('#initiative_sidebar').css('left', '244px');
        $('#section').css('margin-top', '34px');
        $('#section').css('margin-right', '15px');
        $('#section').css('margin-bottom', '0');
        ...
        $('#section').css('margin-right', '15px');
        $('#section').css('margin-bottom', '0');
        $('#section').css('margin-left', '318px');
    } else if (($body.hasClass('side-closed')) && ($body.hasClass('side-closed-hover')) && !($body.hasClass('submenu-closed'))) {
        $('#initiative_sidebar').css('left', '244px');
        $('#section').css('margin-top', '34px');
        $('#section').css('margin-right', '15px');
        $('#section').css('margin-bottom', '0');
