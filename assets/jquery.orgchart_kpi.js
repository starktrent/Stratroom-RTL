    ...
    OrgChart.prototype = {
        ...
        createNode: function(data) {
            ...
            if (opts.nodeTemplate) {
                ...
                // $nodeDiv.append(typeof opts.nodeContent !== 'undefined' ? '<div class="orgiz_structure_Kpi_div kpi_green_border"><div class="orgiz_add"><a href="#"><img src="../../assets/images/awsomefont_add.png" alt="Add" width="15"></a></div><div class="orgiz_edit"><a href="#"><img src="../../assets/images/awsomefont_edit.png" alt="Edit" width="15"></a></div><div class="orgiz_delete"><a href="#"><img src="../../assets/images/awsomefont_delete.png" alt="Delete" width="15"></a></div><div class="org_kpi_description">Key business process with completed quality review</div><div class="org_kpi_deparment">Management</div><div class="d-flex flex-row"><div class="flex-column org_kpi_div_actual"><div class="org_kpi_actual">Actual</div><div class="org_kpi_actual_value">$ 12690.2</div></div> <div class="flex-column org_kpi_div_target"><div class="org_kpi_target">Target</div><div class="org_kpi_target_value">$ 12894.2</div></div> <div class="flex-column org_kpi_div_gap"><div class="org_kpi_actual">Gap</div><div class="org_kpi_actual_value">$ 12690.2</div></div> </div></div>' : '');
